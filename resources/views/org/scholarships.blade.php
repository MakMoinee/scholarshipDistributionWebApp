                    ...
                    <div class="col-lg-12">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <div class="row mt-4">
                                    <div class="col-lg-12">
                                        <label for="requirements" class="text-dark">Requirements:<span
                                                class="text-danger">*</span> </label>
                                        <textarea required name="requirements" id="" cols="30" rows="10" class="form-control"></textarea>
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="col-lg-12">
                                        <label for="requirements" class="text-dark"></label>
                                    </div>
                                </div>
